    ...
    <header className="w-full border-b border-border bg-card sticky top-0 z-40 shadow-xs">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <a href="#" className="outline-hidden group">
            <img
        ...
        <div className="hidden lg:block lg:w-2/5 relative">
          <input
            ...
            className="w-full border border-gray-300 dark:border-border/60 text-gray-900 dark:text-foreground rounded-lg focus:shadow-[0_0_0_.25rem_rgba(10,173,10,.25)] focus:border-primary block p-2 px-3 outline-hidden w-full text-base bg-card placeholder:text-muted-foreground/50 transition-all duration-200"
          />
          <button
        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-6 text-xs font-bold text-muted-foreground">
              {["Home", "Shop", "Stores", "Mega menu", "Pages", "Account", "Dashboard"].map((link) => (
          ...
          <div className="hidden lg:block text-xs font-bold text-primary">
            🎉 Get 20% off on your first order! Use code: <span className="underline uppercase">FRESH20</span>
          </div>
        </div>
      </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>Deliver to: <span className="text-foreground">{location}</span></span>
              </div>
              <IoChevronDownOutline className="size-3.5" />
            </button>
